...
Makers are Electron Forge's way of taking your packaged application and generating platform-specific distributable formats like [DMG](dmg.mdx), [MSIX](msix.md), or [Flatpak](flatpak.md) files (amongst others).
