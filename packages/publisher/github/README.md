...
Configuration options are documented in [`PublisherGitHubConfig`](https://js.electronforge.io/interfaces/_electron-forge_publisher-github.PublisherGitHubConfig.html).
