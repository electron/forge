...
Configuration options are documented in [`PublisherERSConfig`](https://js.electronforge.io/interfaces/_electron-forge_publisher-electron-release-server.PublisherERSConfig.html).
