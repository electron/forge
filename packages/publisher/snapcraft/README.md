...
Configuration options are documented in [PublisherSnapConfig](https://js.electronforge.io/interfaces/_electron-forge_publisher-snapcraft.PublisherSnapcraftConfig.html).
