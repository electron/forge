...
class ViteReactTypeScriptTemplate extends BaseTemplate {
    ...
    return [
      ...
      },
      {
        ...
        task: async () => {
          ...
          await this.copyTemplateFile(path.join(directory, 'src'), 'index.tsx');
          ...
          await this.updateFileByLine(
            ...
            (line) => {
              ...
              if (line.includes('</body>'))
                return '    <script type="module" src="/src/renderer.tsx"></script>\n  </body>';
              return line;
            },
          );
...
export default new ViteReactTypeScriptTemplate();
